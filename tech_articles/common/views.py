...
from tech_articles.content.models import Article, Category, Clap, Comment, CommentLike, FeaturedArticles, Like
...
class ArticleCommentApiView(LoginRequiredMixin, View):
    """
    API endpoint for creating comments on an article.
    ...
    def get(self, request, article_id):
        ...
        comments = Comment.objects.filter(article=article).select_related('user')[:50]
        result = []
