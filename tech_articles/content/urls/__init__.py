...
from .article_public_urls import urlpatterns as article_public_urls
...
from .course_dashboard_urls import urlpatterns as course_dashboard_urls

app_name = "content"

urlpatterns = categories_urls + tags_urls + article_urls + article_public_urls + course_public_urls + course_dashboard_urls
