...
class PlanFeaturesManager {
    ...
    renderEmptyState() {
        ...
        emptyState.innerHTML = `
            ...
            <p class="text-sm">${this.getTranslation('no_features')}</p>
        `;
            ...
            <div class="flex items-start gap-3">
                ...
                <div class="flex-shrink-0 pt-2">
                    <button type="button" 
                            ...
                            data-index="${index}"
                            title="${feature.is_included ? this.getTranslation('included') : this.getTranslation('excluded')}">
                        ${feature.is_included 
                ...
                <div class="flex-grow space-y-3">
                    <div>
                        <input type="text" 
                               ...
                               placeholder="${this.getTranslation('feature_name_placeholder')}"
                    ...
                    <div>
                        <textarea class="feature-description dashboard-textarea w-full" 
                                  rows="2"
                                  placeholder="${this.getTranslation('feature_description_placeholder')}"
                ...
                <div class="flex-shrink-0 pt-2">
                    <button type="button" 
                            ...
                            data-index="${index}"
                            title="${this.getTranslation('remove')}">
