...
class ArticleInteractions {
  ...
  bindClapButton() {
    ...
    clapBtn.addEventListener('click', async (e) => {
      ...
      try {
        const response = await this.apiCall('POST', `/api/articles/${this.articleId}/clap/`);
  ...
  bindLikeButton() {
    ...
    likeBtn.addEventListener('click', async (e) => {
      ...
      try {
        const response = await this.apiCall('POST', `/api/articles/${this.articleId}/like/`);
  ...
  bindCommentSubmit() {
    ...
    submitBtn.addEventListener('click', async (e) => {
      ...
      try {
        ...
        const response = await this.apiCall('POST', `/api/articles/${this.articleId}/comments/`, {
          content: content
        });
  ...
  bindCommentLikes() {
    document.addEventListener('click', async (e) => {
      ...
      try {
        const response = await this.apiCall('POST', `/api/comments/${commentId}/like/`);
      ...
      <div class="article-comment-item" data-comment-id="${comment.id}">
        ...
        <div class="article-comment-body">
          <div class="article-comment-header">
            <span class="article-comment-author">${comment.user.name}</span>
