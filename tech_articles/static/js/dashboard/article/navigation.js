...
const SidebarManager = (function () {
     ...
     * @returns {boolean} - Initial state (true for collapsed on mobile, false for expanded on desktop)
     */
    function getInitialSidebarState() {
        // Default: expanded on desktop (isSidebarExpanded = true), collapsed on mobile (isSidebarExpanded = false)
        return !isMobile;
    }
    ...
    function updateResponsiveState() {
        ...
        if (isMobile) {
            ...
            toggleMenuElements(true); // Always show text in mobile
        } else {
    ...
    function applyState(state) {
        ...
        elements.sidebarHeader?.classList.remove(state === 'expanded' ? 'justify-between' : 'justify-center');
